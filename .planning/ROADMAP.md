...
Plans:
- [ ] 01-01: Supabase schema and RLS policies
- [ ] 01-02: SQL views and pick_next_lead() RPC function
- [ ] 01-03: retell-sdk 5.x upgrade and phone number weighted agents migration
...
|-------|----------------|--------|-----------|
| 1. Foundation + SDK Migration | 0/3 | Not started | - |
